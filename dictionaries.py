...
def without_duplicates(words):
    ...
    #if empty list passed as argument, returns an empty list
    if words == "[]":
        return []
...
def find_unique_common_items(items1, items2):
    ...
    **IMPORTANT**: you may not use `'if ___ in ___``
    ...
    common_unique_items = unique_items1&unique_items2

    return (common_unique_items)

   #return list(set(items1)&set(items2))  <-- more condensed solution
...
def get_sum_zero_pairs(numbers):
    ...
    for num1 in numbers:
        for num2 in numbers:
            if (num1 + num2 == 0) and (num2, num1) not in paired_list:
                paired_list.add((num1, num2))
    
    return list(paired_list)
...
def top_chars(phrase):
    ...
    tallies = {} #tally of letters in phrase
    most_common_count = 0 
    ...
    for letter in phrase:
        ...
        #Adds letter to dictionary with letter count
        tallies[letter] = tallies.get(letter, 0) + 1

        #Updates most common letter count
